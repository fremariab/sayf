    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="info" id="searchinfo">
                ...
                <div class="error" id="error" style="color:#54177c;display: flex; justify-content: center; align-items: center;margin-top:90px;"> </div>

                <div class="results" id="results" style="width:80%;display: flex;  margin-left:70px;  align-items: center;margin-top:30px;">
                    <center>
                        <h1>
                ...
                <i class="fas fa-arrow-up" class="backToTopBtn" id="backToTopBtn" style="color:white;background-color:#54177c;float:right; width:20px;height:20px;font-size:18px"></i>
